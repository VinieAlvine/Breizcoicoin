<?php 
  ...
  if (isset($_SESSION["connecte"])) {
    ...
    if(isset($_POST['supprimer']))
    {
      ...
      $req=$bdb->prepare("DELETE FROM annonce WHERE idannonce='$_GET[id]' ");
     $req->execute();
      //echo '<script type="text/javascript">alert("annonce supprimer avec succès");</script>';
...
<div class="container-fluid">
            <div class="container">
                  ...
                  <div class=" col-sm-8 col-sm-offset-2">
                        ...
                        <form class=" well form" enctype="multipart/form-data" method="POST"action="suprimerannonce.php<?php if (isset($_GET['id'])) echo "?id=".$_GET['id']; else echo ""; ?>" > 
      ...
      echo($don['photo']);
                            ...
                            <div class="form-group text-right ">                                                          
                              <button type="submit" class="btn btn-primary" value="enregister" name="supprimer">Supprimer votre annonce</button>                             </div>
    ...
    <tr>    
      ...
      <td><a href="suprimerannonce.php?id=<?php echo $donnees['idannonce'];?>"/><img src="images/option.png"></td>
    </tr>
    <?php 
      }
    ?>  
